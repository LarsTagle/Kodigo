...
define g_name = "Gregory" ##The name of the main character, used to place them on the screen
...
screen nvl_phonetext(dialogue):
    ...
    for id_d, d in enumerate(dialogue):
        if d.who == None: # Narrator
            ...
            if d.who == g_name:
                $ message_frame = "images/Phone Texting Images/phone_received_frame.png"
            else:
                $ message_frame = "images/Phone Texting Images/phone_send_frame.png"
            ...
            hbox:
                ...
                if previous_d_who != d.who:
                    if d.who == g_name:
                        $ message_icon = "images/Phone Texting Images/phone_received_icon.png"
                    elif d.who != g_name and persistent.gender == "male":
                        $ message_icon = "images/Phone Texting Images/phone_send_male_icon.png"
                    elif d.who != g_name and persistent.gender == "female":
                        $ message_icon = "images/Phone Texting Images/phone_send_female_icon.png"
...
style phoneFrame_frame:
    background Transform("images/Phone Texting Images/phone_background.png", xcenter=0.5,yalign=0.5)
    foreground Transform("images/Phone Texting Images/phone_foreground.png", xcenter=0.5,yalign=0.5)

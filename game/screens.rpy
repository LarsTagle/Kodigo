...
style minigame_title_font:
    font "Inter-Regular.ttf"  # Replace "YourFontName.ttf" with the actual font file name
    size 64  # Adjust the font size as needed

# Define custom style for the button
style menu_button:
    font "DejaVuSans.ttf"  # Set the font for the button text
    selected_color "#000000"  # Set the color of the text when the button is selected
